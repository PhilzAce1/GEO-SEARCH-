...
const init = (resultFromServer) => {
    ...
    switch(resultFromServer.weather[0].main){
        case 'Clear':
            document.documentElement.style.setProperty('--bgi',"url('../image/cloud.jpg')");
        break;
        case 'Clouds':
              document.documentElement.style.setProperty('--bgi',"url('../image/cloudy.jpg')");
        ...
        case 'Drizzle':
        case 'mist':
            document.documentElement.style.setProperty('--bgi',"url('../image/rain.jpg')");
            document.documentElement.style.color = 'white'

             break;
        case 'Thunderstorm':
             document.documentElement.style.setProperty('--bgi',"url('../image/thunder.jpg')");
             document.documentElement.style.color = 'white'
        break;
        case 'Snow':
            document.documentElement.style.setProperty('--bgi',"url('../image/snow.jpg')");
            document.documentElement.style.color = 'black'

            break
        case 'Fog':
                document.documentElement.style.setProperty('--bgi',"url('../image/fog2.jpg')");
    ...
    let longitude = document.getElementById('handleLon').innerHTML = resultFromServer.coord.lon
    ...
    let location = document.getElementById('loca').innerHTML = resultFromServer.name
    var today = new Date();
...
document.getElementById("search-btn").addEventListener('click', () => {
   ...
   if (searchTerm) { return searchWeather(searchTerm)}
})
